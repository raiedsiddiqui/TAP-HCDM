  ...
  <div class="container">
    ...
    <nav class="collapse navbar-collapse bs-navbar-collapse">
      ...
      <ul class="nav navbar-nav">
				<li id="navhome"><a href="<c:url value="/"/>">Home</a></li>
				<li><a href="https://maple.myoscar.org:8384/myoscar_ui/login.jsf">Kindred PHR</a></li>
	    		<!--<li id="navclient"><a href="<c:url value="/client"/>">Clients</a></li>    	
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <h2>Don't Panic!</h2>
        <p style="font-size:25px;">If at any time you run into difficulty, you can contact the Volunteer Coordinator, Anne, at 905-523-4444 ext. 101 to connect you with your volunteers, or the Health TAPESTRY research team at 905-525-9140 ext. 20305</p>
      </div>
